                    ...
                    <div class="col-span-7 space-y-6">
                        <x-form action="{{ route('threads.store') }}">
                            <div class="space-y-8">
                                {{-- Title --}}
                                <div>
                                    <x-form.label for="title" value="{{ __('Tytuł') }}" />
                                ...
                                {{-- Category --}}
                                <div>
                                    <x-form.label for="category" value="{{ __('Wątek') }}" />
                                ...
                                <div>
                                    ...
                                    <select name="tags[]" id="tags" multiple x-data="{}" x-init="function () { choices($el) }" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                       @foreach($tags as $tag)
                                ...
                                {{-- Body --}}
                                <div>
                                    <x-form.label for="body" value="{{ __('Tekst') }}" />
